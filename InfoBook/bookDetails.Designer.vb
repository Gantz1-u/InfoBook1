...
Partial Class BookDetails
    ...
    Private Sub InitializeComponent()
        ...
        Bt_BackMember1 = New Guna.UI2.WinForms.Guna2Button()
        Bt_BorrowMember = New Guna.UI2.WinForms.Guna2Button()
        ...
        ' PNL_BorrowDetails
        ' 
        PNL_BorrowDetails.BackgroundImage = My.Resources.Resources.NAME
        PNL_BorrowDetails.BackgroundImageLayout = ImageLayout.Stretch
        PNL_BorrowDetails.Controls.Add(Bt_BackMember1)
        PNL_BorrowDetails.Controls.Add(Bt_BorrowMember)
        PNL_BorrowDetails.Controls.Add(Guna2TextBox7)
        ...
        PNL_BorrowDetails.Controls.Add(Label12)
        ...
        PNL_BorrowDetails.Location = New Point(23, 425)
        PNL_BorrowDetails.Margin = New Padding(3, 2, 3, 2)
        PNL_BorrowDetails.Name = "PNL_BorrowDetails"
        PNL_BorrowDetails.Size = New Size(55, 26)
        PNL_BorrowDetails.TabIndex = 11
        PNL_BorrowDetails.Visible = False
        ' 
        ' Bt_BackMember1
        ' 
        Bt_BackMember1.BackColor = Color.Transparent
        Bt_BackMember1.CustomizableEdges = CustomizableEdges1
        Bt_BackMember1.DisabledState.BorderColor = Color.DarkGray
        Bt_BackMember1.DisabledState.CustomBorderColor = Color.DarkGray
        Bt_BackMember1.DisabledState.FillColor = Color.FromArgb(CByte(169), CByte(169), CByte(169))
        Bt_BackMember1.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        Bt_BackMember1.FillColor = Color.FromArgb(CByte(252), CByte(246), CByte(219))
        Bt_BackMember1.Font = New Font("Segoe UI", 13.2000008F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Bt_BackMember1.ForeColor = Color.Black
        Bt_BackMember1.Location = New Point(547, 18)
        Bt_BackMember1.Margin = New Padding(3, 2, 3, 2)
        Bt_BackMember1.Name = "Bt_BackMember1"
        Bt_BackMember1.ShadowDecoration.CustomizableEdges = CustomizableEdges2
        Bt_BackMember1.Size = New Size(76, 31)
        Bt_BackMember1.TabIndex = 15
        Bt_BackMember1.Text = "Back"
        ' 
        ' Bt_BorrowMember
        ' 
        Bt_BorrowMember.BackColor = Color.Transparent
        Bt_BorrowMember.BorderRadius = 30
        Bt_BorrowMember.CustomizableEdges = CustomizableEdges3
        Bt_BorrowMember.DisabledState.BorderColor = Color.DarkGray
        Bt_BorrowMember.DisabledState.CustomBorderColor = Color.DarkGray
        Bt_BorrowMember.DisabledState.FillColor = Color.FromArgb(CByte(169), CByte(169), CByte(169))
        Bt_BorrowMember.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        Bt_BorrowMember.FillColor = Color.FromArgb(CByte(191), CByte(188), CByte(188))
        Bt_BorrowMember.Font = New Font("Segoe UI", 16F, FontStyle.Bold)
        Bt_BorrowMember.ForeColor = Color.Black
        Bt_BorrowMember.Location = New Point(286, 422)
        Bt_BorrowMember.Margin = New Padding(3, 2, 3, 2)
        Bt_BorrowMember.Name = "Bt_BorrowMember"
        Bt_BorrowMember.ShadowDecoration.CustomizableEdges = CustomizableEdges4
        Bt_BorrowMember.Size = New Size(169, 42)
        Bt_BorrowMember.TabIndex = 14
        Bt_BorrowMember.Text = "BORROW"
        ' 
        ' Guna2TextBox7
        ' 
        Guna2TextBox7.BackColor = Color.Transparent
        Guna2TextBox7.BorderRadius = 30
        ...
        Guna2TextBox7.Location = New Point(204, 364)
        ...
        Guna2TextBox7.Size = New Size(406, 41)
        ...
        Guna2TextBox6.Location = New Point(204, 305)
        ...
        Guna2TextBox6.Size = New Size(406, 41)
        ...
        Guna2TextBox5.Location = New Point(204, 250)
        ...
        Guna2TextBox5.Size = New Size(406, 41)
        ...
        Guna2TextBox2.Font = New Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Guna2TextBox2.ForeColor = Color.Black
        Guna2TextBox2.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        Guna2TextBox2.Location = New Point(204, 78)
        Guna2TextBox2.Name = "Guna2TextBox2"
        Guna2TextBox2.PasswordChar = ChrW(0)
        Guna2TextBox2.PlaceholderText = ""
        Guna2TextBox2.SelectedText = ""
        Guna2TextBox2.ShadowDecoration.CustomizableEdges = CustomizableEdges16
        Guna2TextBox2.Size = New Size(406, 41)
        ...
        Label12.Location = New Point(50, 372)
        ...
        Label10.Location = New Point(95, 317)
        ...
        Label8.Location = New Point(113, 206)
        Label8.Name = "Label8"
        ...
        Label6.Location = New Point(105, 88)
        Label6.Name = "Label6"
        ...
        Bt_BackBMTND.CustomizableEdges = CustomizableEdges19
        ...
        Bt_BackBMTND.ShadowDecoration.CustomizableEdges = CustomizableEdges20
    ...
    Friend WithEvents Bt_BackMember1 As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents Bt_BorrowMember As Guna.UI2.WinForms.Guna2Button
